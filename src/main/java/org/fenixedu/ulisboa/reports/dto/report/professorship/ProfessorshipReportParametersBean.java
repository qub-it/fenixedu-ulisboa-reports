package org.fenixedu.ulisboa.reports.dto.report.professorship;
...
public class ProfessorshipReportParametersBean implements IBean {
    ...
    public ProfessorshipReportParametersBean() {
        updateData();
    }
